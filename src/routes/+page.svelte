...
<svelte:head>
	<title>Husam Abadi - Main page</title>
</svelte:head>
<main>
	...
	<div class="icons">
		...
		<a
			href="https://github.com/HusamAbadi"
			aria-label="GitHub"
			target="_blank"
		...
		<a
			href="https://www.linkedin.com/in/husamaldein-abadi/"
			aria-label="Linkedin"
			target="_blank"
			rel="noopener noreferrer"
		>
		...
		<!-- <a
			href="https://medium.com/@husamaldeinabadi"
			aria-label="Medium"
			target="_blank"
			rel="noopener noreferrer"
		>
